...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      'AI Wealth Coach (step-by-step planner: saved Emergency Fund & Net Worth leverage checks, wrapper, contribution boost, extra years, contribution escalation, full TFSA allowance, unused Budget surplus, and redirecting debt payments once you\'re debt-free)',
